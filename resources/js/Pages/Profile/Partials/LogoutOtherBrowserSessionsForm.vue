...
const logoutOtherBrowserSessions = () => {
  if (usePage().props.demo) {
    usePage().props.flash.error = t('This feature is disabled on demo.');
    return false;
  }
  ...
  <ActionSection>
    ...
    <template #content>
      ...
      <div class="flex items-center mt-5">
        ...
        <ActionMessage :on="form.recentlySuccessful" class="ml-3"> {{ t('Done.') }} </ActionMessage>
      </div>

      <!-- Log Out Other Devices Confirmation Modal -->
      <DialogModal :show="confirmingLogout" @close="closeModal" max-width="md">
