          ...
          <div class="sm:rounded-lg">
            <div class="p-6 sm:rounded-t-lg border-b border-gray-200 dark:border-gray-700 block md:flex md:items-center md:justify-between">
              ...
              <div class="mt-4 sm:mt-0 block sm:flex sm:items-center sm:gap-4">
                <Button v-if="$can('create-users')" :href="route('users.create')">{{ t('Add New User') }}</Button>
            ...
            <div class="bg-gray-50 dark:bg-black/50 border-b dark:border-gray-700 sm:rounded-b-lg">
              <div v-if="users && users.data && users.data.length">
                <div class="flex flex-col">
                            ...
                            <tr>
                              <th scope="col" class="relative w-12 px-6 sm:w-16 sm:px-8">
                                <input
                                  ...
                                  :checked="indeterminate || form.selection.length === users.data.length"
                                  @change="form.selection = $event.target.checked ? users.data.map(p => p.id) : []"
                          ...
                          <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900">
                            ...
                            >
                              ...
                              <td class="whitespace-nowrap py-4 px-3 text-sm font-medium">
                                <div class="focus:outline-hidden flex items-center focus:text-indigo-500">
                              ...
                              <td class="whitespace-nowrap px-3 py-4 text-sm text-center">
                                <span :class="user.roles.find(r => r.name == 'customer') ? 'opacity-50' : ''">
                              ...
                              <td class="px-3 py-4 text-sm">
                                <div
                                  ...
                                  v-html="$extra_attributes(user.extra_attributes)"
                                ></div>
                              </td>
                              <td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 w-20">
                                <row-actions
                                  ...
                                  :editStr="user.roles.find(r => r.name == 'customer') ? null : route('users.edit', user.id)"
                                />
                              </td>
                            </tr>
                          </tbody>
                  ...
                  <pagination class="m-4" :meta="users.meta" :links="users.links" />
                </div>
              </div>
